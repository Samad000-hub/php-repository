...
//    $post_comment_count=4;
   ...
   $query="INSERT INTO posts(post_category_id, post_title, post_author, post_image, post_date,
                            post_content,post_tags, post_status) ";

    $query .= "VALUES( {$post_category_id}, '{$post_title}', '{$post_author}',
                        '{$post_image}', now() , '{$post_content}',
...
<div class="form-group">
    <input type="submit" class="btn btn-primary form-control" name="create_post" value="Publish Post">
</div>
